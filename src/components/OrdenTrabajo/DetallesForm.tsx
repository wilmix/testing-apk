...
export const DetallesForm: React.FC<DetallesFormProps> = ({
  ...
  return (
    ...
    >
            ...
            <View key={detalle.id} style={styles.detalleContainer}>
              ...
              <TouchableOpacity
                style={[
                  ...
                  isDark ? styles.darkDetalleHeader : styles.lightDetalleHeader,
                ]}
                onPress={() =>
              ...
              >
                <View style={styles.detalleHeaderContent}>
                  <Text style={[styles.detalleHeaderTitle, isDark ? styles.darkText : styles.lightText]}>
              ...
              {isExpanded && (
                <View
                  style={[
                    ...
                    isDark ? styles.darkDetalleContent : styles.lightDetalleContent,
                  ]}
                >
                  {/* Número de extintor */}
                  <FormInput
                  ...
                  {data.detalles.length > 1 && (
                    <TouchableOpacity
                      style={[styles.removeButton, isDark ? styles.darkRemoveButton : styles.lightRemoveButton]}
                      onPress={() => handleRemoveDetalle(detalle.id)}
                    >
                      <Text style={styles.removeButtonText}>🗑️ Remover este extintor</Text>
                    </TouchableOpacity>
                  )}
                </View>
              )}
      ...
      <TouchableOpacity
        style={[styles.addButton, isDark ? styles.darkAddButton : styles.lightAddButton]}
        onPress={handleAddDetalle}
      >
        <Text style={styles.addButtonText}>➕ Agregar otro extintor</Text>
      </TouchableOpacity>

      {/* Status de validación */}
      <View style={[styles.validationBox, isDark ? styles.darkValidationBox : styles.lightValidationBox]}>
        {isFormValid ? (
          <>
            <Text style={[styles.validationTitle, styles.validText]}>✅ Lista válida</Text>
            <Text style={[styles.validationDetail, isDark ? styles.darkText : styles.lightText]}>
              {data.detalles.length} extintor{data.detalles.length !== 1 ? 'es' : ''} agregado{data.detalles.length !== 1 ? 's' : ''}
            </Text>
          </>
        ) : (
          <>
            <Text style={[styles.validationTitle, styles.errorText]}>❌ Hay errores</Text>
            <Text style={[styles.validationDetail, isDark ? styles.darkText : styles.lightText]}>
      ...
      {isFormValid && (
        <View style={[styles.successBox, isDark ? styles.darkSuccessBox : styles.lightSuccessBox]}>
          <Text style={[styles.successText, isDark ? styles.darkText : styles.lightText]}>
      ...
      <TouchableOpacity
        style={[
          ...
          isDark ? styles.darkContinueButton : styles.lightContinueButton,
        ]}
        onPress={onContinue}
